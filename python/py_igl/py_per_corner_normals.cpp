...
py::arg("V"), py::arg("F"), py::arg("corner_threshold"));
...
py::arg("V"), py::arg("F"), py::arg("FN"), py::arg("corner_threshold"));
...
py::arg("V"), py::arg("F"), py::arg("FN"), py::arg("corner_threshold"), py::arg("VF"));
